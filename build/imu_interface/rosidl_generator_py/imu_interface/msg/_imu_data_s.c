...
bool imu_interface__msg__imu_data__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("imu_interface.msg._imu_data.ImuData", full_classname_dest, 35) == 0);
  }
  imu_interface__msg__ImuData * ros_message = _ros_message;
  {  // header
  ...
  {  // timestamp_unix_ns
    PyObject * field = PyObject_GetAttrString(_pymsg, "timestamp_unix_ns");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->timestamp_unix_ns = PyLong_AsUnsignedLongLong(field);
    Py_DECREF(field);
  }
  {  // timestamp_unix_seconds
    ...
    ros_message->timestamp_unix_seconds = PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
  {  // acceleration
...
PyObject * imu_interface__msg__imu_data__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("imu_interface.msg._imu_data");
  ...
  {  // timestamp_unix_ns
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLongLong(ros_message->timestamp_unix_ns);
    {
      int rc = PyObject_SetAttrString(_pymessage, "timestamp_unix_ns", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
