  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__SvoStatus * ros_message = static_cast<const zed_msgs__msg__SvoStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__SvoStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__SvoStatus * ros_message = static_cast<zed_msgs__msg__SvoStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__SvoStatus(cdr, ros_message);
}
