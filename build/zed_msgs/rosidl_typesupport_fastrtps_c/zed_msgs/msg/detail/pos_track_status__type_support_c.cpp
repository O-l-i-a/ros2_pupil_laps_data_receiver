...
#include "zed_msgs/msg/detail/pos_track_status__rosidl_typesupport_fastrtps_c.h"
...
using _PosTrackStatus__ros_msg_type = zed_msgs__msg__PosTrackStatus;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_serialize_zed_msgs__msg__PosTrackStatus(
  const zed_msgs__msg__PosTrackStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_deserialize_zed_msgs__msg__PosTrackStatus(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs__msg__PosTrackStatus * ros_message)
{
  // Field name: odometry_status
  {
    cdr >> ros_message->odometry_status;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t get_serialized_size_zed_msgs__msg__PosTrackStatus(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t max_serialized_size_zed_msgs__msg__PosTrackStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs__msg__PosTrackStatus;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_serialize_key_zed_msgs__msg__PosTrackStatus(
  const zed_msgs__msg__PosTrackStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: odometry_status
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t get_serialized_size_key_zed_msgs__msg__PosTrackStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _PosTrackStatus__ros_msg_type * ros_message = static_cast<const _PosTrackStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t max_serialized_size_key_zed_msgs__msg__PosTrackStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__PosTrackStatus * ros_message = static_cast<const zed_msgs__msg__PosTrackStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__PosTrackStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__PosTrackStatus * ros_message = static_cast<zed_msgs__msg__PosTrackStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__PosTrackStatus(cdr, ros_message);
}

static uint32_t _PosTrackStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_zed_msgs__msg__PosTrackStatus(
...
static size_t _PosTrackStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_msgs__msg__PosTrackStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_msgs, msg, PosTrackStatus)() {
