...
bool cdr_serialize_zed_msgs__msg__GnssFusionStatus(
  const zed_msgs__msg__GnssFusionStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_deserialize_zed_msgs__msg__GnssFusionStatus(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs__msg__GnssFusionStatus * ros_message)
{
  // Field name: gnss_fusion_status
  {
    cdr >> ros_message->gnss_fusion_status;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_serialize_key_zed_msgs__msg__GnssFusionStatus(
  const zed_msgs__msg__GnssFusionStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: gnss_fusion_status
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t get_serialized_size_key_zed_msgs__msg__GnssFusionStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GnssFusionStatus__ros_msg_type * ros_message = static_cast<const _GnssFusionStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t max_serialized_size_key_zed_msgs__msg__GnssFusionStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__GnssFusionStatus * ros_message = static_cast<const zed_msgs__msg__GnssFusionStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__GnssFusionStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__GnssFusionStatus * ros_message = static_cast<zed_msgs__msg__GnssFusionStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__GnssFusionStatus(cdr, ros_message);
}
