...
bool cdr_serialize_zed_msgs__msg__MagHeadingStatus(
  const zed_msgs__msg__MagHeadingStatus * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_deserialize_zed_msgs__msg__MagHeadingStatus(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs__msg__MagHeadingStatus * ros_message)
{
  // Field name: status
  {
    cdr >> ros_message->status;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_serialize_key_zed_msgs__msg__MagHeadingStatus(
  const zed_msgs__msg__MagHeadingStatus * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: status
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t get_serialized_size_key_zed_msgs__msg__MagHeadingStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MagHeadingStatus__ros_msg_type * ros_message = static_cast<const _MagHeadingStatus__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t max_serialized_size_key_zed_msgs__msg__MagHeadingStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__MagHeadingStatus * ros_message = static_cast<const zed_msgs__msg__MagHeadingStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__MagHeadingStatus(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__MagHeadingStatus * ros_message = static_cast<zed_msgs__msg__MagHeadingStatus *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__MagHeadingStatus(cdr, ros_message);
}
