...
#include "zed_msgs/msg/detail/bounding_box3_d__rosidl_typesupport_fastrtps_c.h"
...
#include "zed_msgs/msg/detail/keypoint3_d__functions.h"  // corners

// forward declare type support functions

bool cdr_serialize_zed_msgs__msg__Keypoint3D(
  const zed_msgs__msg__Keypoint3D * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_zed_msgs__msg__Keypoint3D(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs__msg__Keypoint3D * ros_message);

size_t get_serialized_size_zed_msgs__msg__Keypoint3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_zed_msgs__msg__Keypoint3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_zed_msgs__msg__Keypoint3D(
  const zed_msgs__msg__Keypoint3D * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_zed_msgs__msg__Keypoint3D(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_zed_msgs__msg__Keypoint3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_msgs, msg, Keypoint3D)();


using _BoundingBox3D__ros_msg_type = zed_msgs__msg__BoundingBox3D;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: corners
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_zed_msgs__msg__Keypoint3D(
        &array_ptr[i], cdr);
    }
  }
  ...
  zed_msgs__msg__BoundingBox3D * ros_message)
{
  // Field name: corners
  {
    ...
    auto array_ptr = ros_message->corners;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_zed_msgs__msg__Keypoint3D(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: corners
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_zed_msgs__msg__Keypoint3D(
  ...
  size_t current_alignment)
{
  ...
  // Field name: corners
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_zed_msgs__msg__Keypoint3D(
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs__msg__BoundingBox3D;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: corners
  {
    ...
    auto array_ptr = ros_message->corners;
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_zed_msgs__msg__Keypoint3D(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: corners
  {
    ...
    auto array_ptr = ros_message->corners;
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_zed_msgs__msg__Keypoint3D(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: corners
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_zed_msgs__msg__Keypoint3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__BoundingBox3D * ros_message = static_cast<const zed_msgs__msg__BoundingBox3D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__BoundingBox3D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__BoundingBox3D * ros_message = static_cast<zed_msgs__msg__BoundingBox3D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__BoundingBox3D(cdr, ros_message);
}

static uint32_t _BoundingBox3D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_zed_msgs__msg__BoundingBox3D(
...
static size_t _BoundingBox3D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_msgs__msg__BoundingBox3D(
