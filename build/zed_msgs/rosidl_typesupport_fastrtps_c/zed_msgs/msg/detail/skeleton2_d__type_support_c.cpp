...
#include "zed_msgs/msg/detail/skeleton2_d__rosidl_typesupport_fastrtps_c.h"
...
#include "zed_msgs/msg/detail/keypoint2_df__functions.h"  // keypoints
...
using _Skeleton2D__ros_msg_type = zed_msgs__msg__Skeleton2D;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs__msg__Skeleton2D;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__Skeleton2D * ros_message = static_cast<const zed_msgs__msg__Skeleton2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__Skeleton2D(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__Skeleton2D * ros_message = static_cast<zed_msgs__msg__Skeleton2D *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__Skeleton2D(cdr, ros_message);
}

static uint32_t _Skeleton2D__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_zed_msgs__msg__Skeleton2D(
...
static size_t _Skeleton2D__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_zed_msgs__msg__Skeleton2D(
