...
bool cdr_serialize_zed_msgs__msg__HealthStatusStamped(
  const zed_msgs__msg__HealthStatusStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_deserialize_zed_msgs__msg__HealthStatusStamped(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs__msg__HealthStatusStamped * ros_message)
{
  // Field name: header
  {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
bool cdr_serialize_key_zed_msgs__msg__HealthStatusStamped(
  const zed_msgs__msg__HealthStatusStamped * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: header
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t get_serialized_size_key_zed_msgs__msg__HealthStatusStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _HealthStatusStamped__ros_msg_type * ros_message = static_cast<const _HealthStatusStamped__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_zed_msgs
size_t max_serialized_size_key_zed_msgs__msg__HealthStatusStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const zed_msgs__msg__HealthStatusStamped * ros_message = static_cast<const zed_msgs__msg__HealthStatusStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_zed_msgs__msg__HealthStatusStamped(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  zed_msgs__msg__HealthStatusStamped * ros_message = static_cast<zed_msgs__msg__HealthStatusStamped *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_zed_msgs__msg__HealthStatusStamped(cdr, ros_message);
}
