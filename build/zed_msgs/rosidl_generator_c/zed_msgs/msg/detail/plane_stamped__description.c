  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xad, 0xda, 0x87, 0x68, 0x91, 0xee, 0xe7, 0xc0,
      0x69, 0xe5, 0x26, 0xfd, 0x50, 0xdd, 0x59, 0x20,
      0xea, 0x26, 0x66, 0x21, 0xef, 0x4b, 0x6f, 0xa9,
      0x2e, 0x25, 0x98, 0xdd, 0x69, 0x04, 0x1c, 0x46,
    }};
  return &hash;
}
...
static char zed_msgs__msg__PlaneStamped__TYPE_NAME[] = "zed_msgs/msg/PlaneStamped";
...
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__header[] = "header";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__mesh[] = "mesh";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__coefficients[] = "coefficients";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__normal[] = "normal";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__center[] = "center";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__pose[] = "pose";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__extents[] = "extents";
static char zed_msgs__msg__PlaneStamped__FIELD_NAME__bounds[] = "bounds";

static rosidl_runtime_c__type_description__Field zed_msgs__msg__PlaneStamped__FIELDS[] = {
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__header, 6, 6},
    {
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__mesh, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__coefficients, 12, 12},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__normal, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__center, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__pose, 4, 4},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__extents, 7, 7},
    {
  ...
  {
    {zed_msgs__msg__PlaneStamped__FIELD_NAME__bounds, 6, 6},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription zed_msgs__msg__PlaneStamped__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {zed_msgs__msg__PlaneStamped__TYPE_NAME, 25, 25},
      {zed_msgs__msg__PlaneStamped__FIELDS, 8, 8},
    },
    {zed_msgs__msg__PlaneStamped__REFERENCED_TYPE_DESCRIPTIONS, 11, 11},
  };
  if (!constructed) {
...
zed_msgs__msg__PlaneStamped__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *zed_msgs__msg__PlaneStamped__get_individual_type_description_source(NULL),
