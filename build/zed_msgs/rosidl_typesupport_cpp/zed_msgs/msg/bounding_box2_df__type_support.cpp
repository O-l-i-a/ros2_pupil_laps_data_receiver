...
static const _BoundingBox2Df_type_support_symbol_names_t _BoundingBox2Df_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, BoundingBox2Df)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, msg, BoundingBox2Df)),
  }
};
...
{
  return &::zed_msgs::msg::rosidl_typesupport_cpp::BoundingBox2Df_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, msg, BoundingBox2Df)() {
  return get_message_type_support_handle<zed_msgs::msg::BoundingBox2Df>();
}
