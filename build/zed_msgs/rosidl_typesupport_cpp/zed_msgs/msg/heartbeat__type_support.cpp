...
#include "zed_msgs/msg/detail/heartbeat__struct.hpp"
...
static const _Heartbeat_type_support_symbol_names_t _Heartbeat_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, Heartbeat)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, msg, Heartbeat)),
  }
};
...
get_message_type_support_handle<zed_msgs::msg::Heartbeat>()
{
  return &::zed_msgs::msg::rosidl_typesupport_cpp::Heartbeat_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, msg, Heartbeat)() {
  return get_message_type_support_handle<zed_msgs::msg::Heartbeat>();
}
