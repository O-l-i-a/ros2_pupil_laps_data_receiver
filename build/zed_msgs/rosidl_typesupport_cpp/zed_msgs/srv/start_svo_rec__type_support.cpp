...
static const _StartSvoRec_Request_type_support_symbol_names_t _StartSvoRec_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, StartSvoRec_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, StartSvoRec_Request)),
  }
};
...
{
  return &::zed_msgs::srv::rosidl_typesupport_cpp::StartSvoRec_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, srv, StartSvoRec_Request)() {
  return get_message_type_support_handle<zed_msgs::srv::StartSvoRec_Request>();
}
...
static const _StartSvoRec_Response_type_support_symbol_names_t _StartSvoRec_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, StartSvoRec_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, StartSvoRec_Response)),
  }
};
...
{
  return &::zed_msgs::srv::rosidl_typesupport_cpp::StartSvoRec_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, srv, StartSvoRec_Response)() {
  return get_message_type_support_handle<zed_msgs::srv::StartSvoRec_Response>();
}
...
typedef struct _StartSvoRec_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _StartSvoRec_Event_type_support_ids_t;

static const _StartSvoRec_Event_type_support_ids_t _StartSvoRec_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _StartSvoRec_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _StartSvoRec_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _StartSvoRec_Event_type_support_symbol_names_t _StartSvoRec_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, StartSvoRec_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, StartSvoRec_Event)),
  }
};

typedef struct _StartSvoRec_Event_type_support_data_t
{
  void * data[2];
} _StartSvoRec_Event_type_support_data_t;

static _StartSvoRec_Event_type_support_data_t _StartSvoRec_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _StartSvoRec_Event_message_typesupport_map = {
  2,
  "zed_msgs",
  &_StartSvoRec_Event_message_typesupport_ids.typesupport_identifier[0],
  &_StartSvoRec_Event_message_typesupport_symbol_names.symbol_name[0],
  &_StartSvoRec_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t StartSvoRec_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_StartSvoRec_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::zed_msgs::srv::rosidl_typesupport_cpp::StartSvoRec_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, srv, StartSvoRec_Event)() {
  return get_message_type_support_handle<zed_msgs::srv::StartSvoRec_Event>();
}
...
static const _StartSvoRec_type_support_symbol_names_t _StartSvoRec_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, StartSvoRec)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, StartSvoRec)),
  }
};
...
static const rosidl_service_type_support_t StartSvoRec_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<zed_msgs::srv::StartSvoRec_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<zed_msgs::srv::StartSvoRec_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<zed_msgs::srv::StartSvoRec_Event>(),
...
{
  return &::zed_msgs::srv::rosidl_typesupport_cpp::StartSvoRec_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, srv, StartSvoRec)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<zed_msgs::srv::StartSvoRec>();
}
