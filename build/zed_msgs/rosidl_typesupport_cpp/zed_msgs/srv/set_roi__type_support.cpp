...
static const _SetROI_Event_type_support_symbol_names_t _SetROI_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, SetROI_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, zed_msgs, srv, SetROI_Event)),
  }
};
...
{
  return &::zed_msgs::srv::rosidl_typesupport_cpp::SetROI_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, srv, SetROI_Event)() {
  return get_message_type_support_handle<zed_msgs::srv::SetROI_Event>();
}
...
static const rosidl_service_type_support_t SetROI_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<zed_msgs::srv::SetROI_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<zed_msgs::srv::SetROI_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<zed_msgs::srv::SetROI_Event>(),
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, zed_msgs, srv, SetROI)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<zed_msgs::srv::SetROI>();
}
