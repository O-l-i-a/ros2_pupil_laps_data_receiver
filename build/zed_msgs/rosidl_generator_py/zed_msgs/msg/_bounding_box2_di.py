...
class Metaclass_BoundingBox2Di(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from zed_msgs.msg import Keypoint2Di
...
class BoundingBox2Di(metaclass=Metaclass_BoundingBox2Di):
    ...
    _fields_and_field_types = {
        'corners': 'zed_msgs/Keypoint2Di[4]',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'Keypoint2Di'), 4),  # noqa: E501
    )
