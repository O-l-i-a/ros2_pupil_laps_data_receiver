...
class Object(metaclass=Metaclass_Object):
    ...
    _fields_and_field_types = {
        ...
        'tracking_state': 'int8',
        'action_state': 'int8',
        'bounding_box_2d': 'zed_msgs/BoundingBox2Di',
        'bounding_box_3d': 'zed_msgs/BoundingBox3D',
        'dimensions_3d': 'float[3]',
        'skeleton_available': 'boolean',
        'body_format': 'int8',
        'head_bounding_box_2d': 'zed_msgs/BoundingBox2Df',
        'head_bounding_box_3d': 'zed_msgs/BoundingBox3D',
        'head_position': 'float[3]',
        'skeleton_2d': 'zed_msgs/Skeleton2D',
        'skeleton_3d': 'zed_msgs/Skeleton3D',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'BoundingBox2Di'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'BoundingBox3D'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('float'), 3),  # noqa: E501
        rosidl_parser.definition.BasicType('boolean'),  # noqa: E501
        rosidl_parser.definition.BasicType('int8'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'BoundingBox2Df'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'BoundingBox3D'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.BasicType('float'), 3),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'Skeleton2D'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['zed_msgs', 'msg'], 'Skeleton3D'),  # noqa: E501
    )
    ...
    def __eq__(self, other):
        ...
        if self.bounding_box_3d != other.bounding_box_3d:
            return False
        if any(self.dimensions_3d != other.dimensions_3d):
            return False
        ...
        if self.head_bounding_box_3d != other.head_bounding_box_3d:
            return False
        if any(self.head_position != other.head_position):
            return False
