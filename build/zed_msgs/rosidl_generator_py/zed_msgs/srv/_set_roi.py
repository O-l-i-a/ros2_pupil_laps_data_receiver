...
class Metaclass_SetROI_Event(type):
    """Metaclass of message 'SetROI_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_roi__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_roi__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_roi__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_roi__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_roi__event
...
class SetROI_Event(metaclass=Metaclass_SetROI_Event):
    """Message class 'SetROI_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<zed_msgs/SetROI_Request, 1>',
        'response': 'sequence<zed_msgs/SetROI_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zed_msgs', 'srv'], 'SetROI_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zed_msgs', 'srv'], 'SetROI_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from zed_msgs.srv import SetROI_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetROI_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetROI_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from zed_msgs.srv import SetROI_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetROI_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetROI_Response'"
...
class Metaclass_SetROI(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from zed_msgs.srv import _set_roi
            ...
            if _set_roi.Metaclass_SetROI_Event._TYPE_SUPPORT is None:
                _set_roi.Metaclass_SetROI_Event.__import_type_support__()


class SetROI(metaclass=Metaclass_SetROI):
    from zed_msgs.srv._set_roi import SetROI_Request as Request
    from zed_msgs.srv._set_roi import SetROI_Response as Response
    from zed_msgs.srv._set_roi import SetROI_Event as Event
