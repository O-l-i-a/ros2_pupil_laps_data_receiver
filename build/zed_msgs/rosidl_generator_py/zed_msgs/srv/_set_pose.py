...
class SetPose_Request(metaclass=Metaclass_SetPose_Request):
    ...
    def __eq__(self, other):
        ...
        if any(self.pos != other.pos):
            return False
        if any(self.orient != other.orient):
            return False
        return True
...
class Metaclass_SetPose_Event(type):
    """Metaclass of message 'SetPose_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'zed_msgs.srv.SetPose_Event')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_pose__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_pose__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_pose__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_pose__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_pose__event
...
class SetPose_Event(metaclass=Metaclass_SetPose_Event):
    """Message class 'SetPose_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<zed_msgs/SetPose_Request, 1>',
        'response': 'sequence<zed_msgs/SetPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zed_msgs', 'srv'], 'SetPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['zed_msgs', 'srv'], 'SetPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from zed_msgs.srv import SetPose_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetPose_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetPose_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from zed_msgs.srv import SetPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetPose_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetPose_Response'"
...
class Metaclass_SetPose(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from zed_msgs.srv import _set_pose
            ...
            if _set_pose.Metaclass_SetPose_Event._TYPE_SUPPORT is None:
                _set_pose.Metaclass_SetPose_Event.__import_type_support__()


class SetPose(metaclass=Metaclass_SetPose):
    from zed_msgs.srv._set_pose import SetPose_Request as Request
    from zed_msgs.srv._set_pose import SetPose_Response as Response
    from zed_msgs.srv._set_pose import SetPose_Event as Event
