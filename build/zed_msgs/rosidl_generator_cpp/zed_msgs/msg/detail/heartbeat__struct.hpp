...
// IWYU pragma: private, include "zed_msgs/msg/heartbeat.hpp"


#ifndef ZED_MSGS__MSG__DETAIL__HEARTBEAT__STRUCT_HPP_
#define ZED_MSGS__MSG__DETAIL__HEARTBEAT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__zed_msgs__msg__Heartbeat __attribute__((deprecated))
#else
# define DEPRECATED__zed_msgs__msg__Heartbeat __declspec(deprecated)
#endif
...
struct Heartbeat_
{
  ...
  // pointer types
  using RawPtr =
    zed_msgs::msg::Heartbeat_<ContainerAllocator> *;
  using ConstRawPtr =
    const zed_msgs::msg::Heartbeat_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      zed_msgs::msg::Heartbeat_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__zed_msgs__msg__Heartbeat
    std::shared_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__zed_msgs__msg__Heartbeat
    std::shared_ptr<zed_msgs::msg::Heartbeat_<ContainerAllocator> const>
...
using Heartbeat =
  zed_msgs::msg::Heartbeat_<std::allocator<void>>;
...
#endif  // ZED_MSGS__MSG__DETAIL__HEARTBEAT__STRUCT_HPP_
