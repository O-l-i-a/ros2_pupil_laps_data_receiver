...
// IWYU pragma: private, include "zed_msgs/msg/object.hpp"


#ifndef ZED_MSGS__MSG__DETAIL__OBJECT__STRUCT_HPP_
#define ZED_MSGS__MSG__DETAIL__OBJECT__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__zed_msgs__msg__Object __attribute__((deprecated))
#else
# define DEPRECATED__zed_msgs__msg__Object __declspec(deprecated)
#endif
...
struct Object_
{
  ...
  using _bounding_box_2d_type =
    zed_msgs::msg::BoundingBox2Di_<ContainerAllocator>;
  _bounding_box_2d_type bounding_box_2d;
  using _bounding_box_3d_type =
    zed_msgs::msg::BoundingBox3D_<ContainerAllocator>;
  ...
  using _skeleton_2d_type =
    zed_msgs::msg::Skeleton2D_<ContainerAllocator>;
  ...
  Type & set__bounding_box_2d(
    const zed_msgs::msg::BoundingBox2Di_<ContainerAllocator> & _arg)
  {
    this->bounding_box_2d = _arg;
    return *this;
  }
  Type & set__bounding_box_3d(
    const zed_msgs::msg::BoundingBox3D_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__head_bounding_box_2d(
    const zed_msgs::msg::BoundingBox2Df_<ContainerAllocator> & _arg)
  {
  ...
  Type & set__skeleton_2d(
    const zed_msgs::msg::Skeleton2D_<ContainerAllocator> & _arg)
  {
    this->skeleton_2d = _arg;
    return *this;
  }
  Type & set__skeleton_3d(
    const zed_msgs::msg::Skeleton3D_<ContainerAllocator> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    zed_msgs::msg::Object_<ContainerAllocator> *;
  using ConstRawPtr =
    const zed_msgs::msg::Object_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<zed_msgs::msg::Object_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<zed_msgs::msg::Object_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      zed_msgs::msg::Object_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<zed_msgs::msg::Object_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<zed_msgs::msg::Object_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<zed_msgs::msg::Object_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<zed_msgs::msg::Object_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__zed_msgs__msg__Object
    std::shared_ptr<zed_msgs::msg::Object_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__zed_msgs__msg__Object
    std::shared_ptr<zed_msgs::msg::Object_<ContainerAllocator> const>
...
using Object =
  zed_msgs::msg::Object_<std::allocator<void>>;
...
#endif  // ZED_MSGS__MSG__DETAIL__OBJECT__STRUCT_HPP_
