...
// IWYU pragma: private, include "zed_msgs/msg/plane_stamped.hpp"


#ifndef ZED_MSGS__MSG__DETAIL__PLANE_STAMPED__STRUCT_HPP_
#define ZED_MSGS__MSG__DETAIL__PLANE_STAMPED__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__zed_msgs__msg__PlaneStamped __attribute__((deprecated))
#else
# define DEPRECATED__zed_msgs__msg__PlaneStamped __declspec(deprecated)
#endif
...
struct PlaneStamped_
{
  ...
  // pointer types
  using RawPtr =
    zed_msgs::msg::PlaneStamped_<ContainerAllocator> *;
  using ConstRawPtr =
    const zed_msgs::msg::PlaneStamped_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      zed_msgs::msg::PlaneStamped_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__zed_msgs__msg__PlaneStamped
    std::shared_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__zed_msgs__msg__PlaneStamped
    std::shared_ptr<zed_msgs::msg::PlaneStamped_<ContainerAllocator> const>
...
using PlaneStamped =
  zed_msgs::msg::PlaneStamped_<std::allocator<void>>;
...
#endif  // ZED_MSGS__MSG__DETAIL__PLANE_STAMPED__STRUCT_HPP_
