...
#include "zed_msgs/msg/detail/keypoint3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_msgs::msg::Keypoint3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::Keypoint3D & ros_message)
{
  // Member: kp
  {
    cdr >> ros_message.kp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::Keypoint3D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::Keypoint3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::Keypoint3D *>(
    untyped_ros_message);
...
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Keypoint3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, Keypoint3D)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Keypoint3D__handle;
}
