...
#include "zed_msgs/msg/detail/objects_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_msgs::msg::ObjectsStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::ObjectsStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::ObjectsStamped;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_ObjectsStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Object(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::ObjectsStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::ObjectsStamped *>(
    untyped_ros_message);
...
get_message_type_support_handle<zed_msgs::msg::ObjectsStamped>()
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_ObjectsStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, ObjectsStamped)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_ObjectsStamped__handle;
}
