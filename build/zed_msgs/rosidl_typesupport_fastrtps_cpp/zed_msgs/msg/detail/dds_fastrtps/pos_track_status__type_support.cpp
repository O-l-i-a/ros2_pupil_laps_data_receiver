...
#include "zed_msgs/msg/detail/pos_track_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_msgs::msg::PosTrackStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::PosTrackStatus & ros_message)
{
  // Member: odometry_status
  cdr >> ros_message.odometry_status;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::PosTrackStatus;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_PosTrackStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::PosTrackStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::PosTrackStatus *>(
    untyped_ros_message);
...
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_PosTrackStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, PosTrackStatus)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_PosTrackStatus__handle;
}
