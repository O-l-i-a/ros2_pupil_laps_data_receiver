...
#include "zed_msgs/msg/detail/skeleton2_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_msgs::msg::Skeleton2D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::Skeleton2D & ros_message)
{
  // Member: keypoints
  {
    for (size_t i = 0; i < 70; i++) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::Skeleton2D;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::Skeleton2D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::Skeleton2D *>(
    untyped_ros_message);
...
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Skeleton2D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, Skeleton2D)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Skeleton2D__handle;
}
