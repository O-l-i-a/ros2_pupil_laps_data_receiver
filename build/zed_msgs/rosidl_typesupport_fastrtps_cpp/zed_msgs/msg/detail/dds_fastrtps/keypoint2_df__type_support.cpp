...
#include "zed_msgs/msg/detail/keypoint2_df__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_msgs::msg::Keypoint2Df & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::Keypoint2Df & ros_message)
{
  // Member: kp
  {
    cdr >> ros_message.kp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::Keypoint2Df;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::Keypoint2Df *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::Keypoint2Df *>(
    untyped_ros_message);
...
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Keypoint2Df__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, Keypoint2Df)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Keypoint2Df__handle;
}
