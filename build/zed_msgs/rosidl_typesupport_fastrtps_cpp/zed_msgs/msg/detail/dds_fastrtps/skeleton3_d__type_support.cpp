...
#include "zed_msgs/msg/detail/skeleton3_d__rosidl_typesupport_fastrtps_cpp.hpp"
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_Keypoint3D(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const zed_msgs::msg::Skeleton3D & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::Skeleton3D & ros_message)
{
  // Member: keypoints
  {
    for (size_t i = 0; i < 70; i++) {
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::Skeleton3D;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: keypoints
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Keypoint3D(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::Skeleton3D *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::Skeleton3D *>(
    untyped_ros_message);
...
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Skeleton3D__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, Skeleton3D)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_Skeleton3D__handle;
}
