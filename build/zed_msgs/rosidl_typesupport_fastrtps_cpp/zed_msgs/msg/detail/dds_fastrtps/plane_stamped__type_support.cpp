...
#include "zed_msgs/msg/detail/plane_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const zed_msgs::msg::PlaneStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::PlaneStamped & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::PlaneStamped;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_PlaneStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::PlaneStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::PlaneStamped *>(
    untyped_ros_message);
...
get_message_type_support_handle<zed_msgs::msg::PlaneStamped>()
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_PlaneStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, PlaneStamped)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_PlaneStamped__handle;
}
