...
#include "zed_msgs/msg/detail/bounding_box2_di__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const zed_msgs::msg::Keypoint2Di &,
...
size_t get_serialized_size_key(
  ...
  size_t current_alignment);
size_t
max_serialized_size_key_Keypoint2Di(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);
}  // namespace typesupport_fastrtps_cpp
...
cdr_serialize(
  const zed_msgs::msg::BoundingBox2Di & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::msg::BoundingBox2Di & ros_message)
{
  // Member: corners
  {
    for (size_t i = 0; i < 4; i++) {
  ...
  size_t current_alignment)
{
  ...
  // Member: corners
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Keypoint2Di(
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::msg::BoundingBox2Di;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: corners
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Keypoint2Di(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const zed_msgs::msg::BoundingBox2Di *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::msg::BoundingBox2Di *>(
    untyped_ros_message);
...
get_message_type_support_handle<zed_msgs::msg::BoundingBox2Di>()
{
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2Di__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, msg, BoundingBox2Di)() {
  return &zed_msgs::msg::typesupport_fastrtps_cpp::_BoundingBox2Di__handle;
}
