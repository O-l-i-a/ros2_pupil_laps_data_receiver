...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_SetSvoFrame_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_SetSvoFrame_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
// functions for zed_msgs::srv::SetSvoFrame_Request already declared above

// functions for zed_msgs::srv::SetSvoFrame_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
cdr_serialize(
  const zed_msgs::srv::SetSvoFrame_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::srv::SetSvoFrame_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_SetSvoFrame_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetSvoFrame_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetSvoFrame_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zed_msgs::srv::SetSvoFrame_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_SetSvoFrame_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetSvoFrame_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetSvoFrame_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const zed_msgs::srv::SetSvoFrame_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<zed_msgs::srv::SetSvoFrame_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetSvoFrame_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const zed_msgs::srv::SetSvoFrame_Event *>(
...
static size_t _SetSvoFrame_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetSvoFrame_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetSvoFrame_Event__callbacks = {
  "zed_msgs::srv",
  "SetSvoFrame_Event",
...
static rosidl_message_type_support_t _SetSvoFrame_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetSvoFrame_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetSvoFrame_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, SetSvoFrame_Event)() {
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetSvoFrame_Event__handle;
}
...
static const rosidl_service_type_support_t _SetSvoFrame__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetSvoFrame__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zed_msgs::srv::SetSvoFrame_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zed_msgs::srv::SetSvoFrame_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zed_msgs::srv::SetSvoFrame_Event>(),
