...
#include "zed_msgs/srv/detail/set_roi__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = zed_msgs::srv::SetROI_Request;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_SetROI_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const zed_msgs::srv::SetROI_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<zed_msgs::srv::SetROI_Request *>(
    untyped_ros_message);
...
{
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetROI_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zed_msgs::srv::SetROI_Response;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_SetROI_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const zed_msgs::srv::SetROI_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<zed_msgs::srv::SetROI_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetROI_Response__handle;
}
...
// functions for zed_msgs::srv::SetROI_Request already declared above

// functions for zed_msgs::srv::SetROI_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
cdr_serialize(
  const zed_msgs::srv::SetROI_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  zed_msgs::srv::SetROI_Event & ros_message)
{
  // Member: info
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_SetROI_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetROI_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_SetROI_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = zed_msgs::srv::SetROI_Event;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_zed_msgs
max_serialized_size_key_SetROI_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetROI_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        zed_msgs::srv::typesupport_fastrtps_cpp::max_serialized_size_key_SetROI_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const zed_msgs::srv::SetROI_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<zed_msgs::srv::SetROI_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetROI_Event__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const zed_msgs::srv::SetROI_Event *>(
...
static size_t _SetROI_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetROI_Event(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetROI_Event__callbacks = {
  "zed_msgs::srv",
  "SetROI_Event",
...
static rosidl_message_type_support_t _SetROI_Event__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetROI_Event__callbacks,
  get_message_typesupport_handle_function,
...
{
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetROI_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, zed_msgs, srv, SetROI_Event)() {
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetROI_Event__handle;
}
...
static const rosidl_service_type_support_t _SetROI__handle{
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetROI__callbacks,
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zed_msgs::srv::SetROI_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zed_msgs::srv::SetROI_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<zed_msgs::srv::SetROI_Event>(),
...
{
  return &zed_msgs::srv::typesupport_fastrtps_cpp::_SetROI__handle;
}
