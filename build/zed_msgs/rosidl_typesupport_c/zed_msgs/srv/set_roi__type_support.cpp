...
static const _SetROI_Request_type_support_symbol_names_t _SetROI_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_msgs, srv, SetROI_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_msgs, srv, SetROI_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zed_msgs, srv, SetROI_Request)() {
  return &::zed_msgs::srv::rosidl_typesupport_c::SetROI_Request_message_type_support_handle;
}
...
static const _SetROI_Response_type_support_symbol_names_t _SetROI_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_msgs, srv, SetROI_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_msgs, srv, SetROI_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zed_msgs, srv, SetROI_Response)() {
  return &::zed_msgs::srv::rosidl_typesupport_c::SetROI_Response_message_type_support_handle;
}
...
typedef struct _SetROI_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _SetROI_Event_type_support_ids_t;

static const _SetROI_Event_type_support_ids_t _SetROI_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_c",  // ::rosidl_typesupport_fastrtps_c::typesupport_identifier,
    "rosidl_typesupport_introspection_c",  // ::rosidl_typesupport_introspection_c::typesupport_identifier,
  }
...
typedef struct _SetROI_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _SetROI_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _SetROI_Event_type_support_symbol_names_t _SetROI_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_msgs, srv, SetROI_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_msgs, srv, SetROI_Event)),
  }
};

typedef struct _SetROI_Event_type_support_data_t
{
  void * data[2];
} _SetROI_Event_type_support_data_t;

static _SetROI_Event_type_support_data_t _SetROI_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _SetROI_Event_message_typesupport_map = {
  2,
  "zed_msgs",
  &_SetROI_Event_message_typesupport_ids.typesupport_identifier[0],
  &_SetROI_Event_message_typesupport_symbol_names.symbol_name[0],
  &_SetROI_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t SetROI_Event_message_type_support_handle = {
  rosidl_typesupport_c__typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_SetROI_Event_message_typesupport_map),
  rosidl_typesupport_c__get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, zed_msgs, srv, SetROI_Event)() {
  return &::zed_msgs::srv::rosidl_typesupport_c::SetROI_Event_message_type_support_handle;
}
...
static const _SetROI_type_support_symbol_names_t _SetROI_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, zed_msgs, srv, SetROI)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, zed_msgs, srv, SetROI)),
  }
};
...
static const rosidl_service_type_support_t SetROI_service_type_support_handle = {
  ...
  &SetROI_Request_message_type_support_handle,
  &SetROI_Response_message_type_support_handle,
  &SetROI_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, zed_msgs, srv, SetROI)() {
  return &::zed_msgs::srv::rosidl_typesupport_c::SetROI_service_type_support_handle;
}
