...
#include "gaze_interface/msg/detail/gaze_data_async__rosidl_typesupport_fastrtps_c.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_gaze_interface
...
using _GazeDataAsync__ros_msg_type = gaze_interface__msg__GazeDataAsync;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: norm_pos_x
  {
    cdr << ros_message->norm_pos_x;
  }

  // Field name: norm_pos_y
  {
...
size_t get_serialized_size_gaze_interface__msg__GazeDataAsync(
  ...
  size_t current_alignment)
{
  const _GazeDataAsync__ros_msg_type * ros_message = static_cast<const _GazeDataAsync__ros_msg_type *>(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gaze_interface__msg__GazeDataAsync;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const gaze_interface__msg__GazeDataAsync * ros_message = static_cast<const gaze_interface__msg__GazeDataAsync *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_gaze_interface__msg__GazeDataAsync(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  gaze_interface__msg__GazeDataAsync * ros_message = static_cast<gaze_interface__msg__GazeDataAsync *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_gaze_interface__msg__GazeDataAsync(cdr, ros_message);
}

static uint32_t _GazeDataAsync__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gaze_interface__msg__GazeDataAsync(
...
static size_t _GazeDataAsync__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gaze_interface__msg__GazeDataAsync(
...
static message_type_support_callbacks_t __callbacks_GazeDataAsync = {
  "gaze_interface::msg",
  "GazeDataAsync",
...
static rosidl_message_type_support_t _GazeDataAsync__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_GazeDataAsync,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gaze_interface, msg, GazeDataAsync)() {
  return &_GazeDataAsync__type_support;
}
